...
// 2
const searchSarahDog = dogs.find((dog) => dog.owners.includes("Sarah"));
console.log(
  `Sarah's dog is eating too ${
    searchSarahDog.curFood > searchSarahDog.recommended ? "much" : "litte"
  } food`
);
...
// 4
const dogsEatTooMuch = `${ownersEatTooMuch.join(" and ")}'s eat too much food`;
const dogsEatTooLittle = `${ownersEatTooLittle.join(
  " and "
)}'s eat too little food`;
